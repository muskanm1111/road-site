      ...
      <div className="bg-white p-4 my-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-7xl mx-auto py-2">
          ...
          <div className="relative bg-white rounded-lg shadow-lg hover:-translate-y-4 transition-transform duration-500 group overflow-hidden">
            {/* Overlay */}
            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/60 transition-all duration-300 z-10"></div>
            ...
            <div className="flex flex-col relative">
              ...
              <div className="w-full p-4 relative z-20">
                <h2 className="text-xl font-bold text-black group-hover:text-white transition-colors duration-300">
                  Card Title
                </h2>
          ...
          <div className="relative bg-white rounded-lg shadow-lg hover:-translate-y-4 transition-transform duration-500 group overflow-hidden">
            ...
            <div className="flex flex-col relative">
              <div className="w-full relative">
                <h3 className="group-hover:text-white text-2xl font-bold opacity-0  group-hover:opacity-100 absolute z-50 left-44 top-36">
                  DETAILS
                </h3>
                <img
